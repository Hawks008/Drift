(function () {
      ...
      <div class="item-row" data-id="${p.id}">
        ...
        <div class="item-row-info">
          ...
          <p class="item-row-meta">
            ...
            ${p.isThrifted ? ' <span class="pill">thrifted</span>' : ''}
  ...
  function openModal(id) {
    ...
    document.getElementById('itemThrifted').checked = product ? Boolean(product.isThrifted) : false;
  ...
  itemForm.addEventListener('submit', async e => {
    ...
    const payload = {
      ...
      colors,
      sizes,
      isThrifted: document.getElementById('itemThrifted').checked,
